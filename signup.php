<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        echo "<script>winow.location='index.php'</script>";
    }
    ?>
...
<main>
    ...
    <form class="panjang" action="signup.php" method="post">
        <table>
            <tr>
                <td>ID Ahli</td>
                <td><input required ype="text" name="idahli"
                placeholder="A065" pattern="[A-Z0-9]{4}"
                oninvalid="this.setCustomValidity('Sila masukkan 4 askara')"
                oninput="this.setCustomValidity('')">
                </td>
            </tr>
            <tr>
                <td>Nama Ahli</td>
                <td><input type="text" name="nnamaahli"></td>
            </tr>
            <tr>
                <td>Password</td>
        ...
        <button class="batal" type="button" onclick="winow.location='index.php'">Batal</button>
    </form>
</main>
